      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            For over 25 years, Traditional Siddha Ayurveda Clinic has been dedicated to bringing authentic Ayurvedic healing to our community.
          </p>
        </div>
                  ...
                  <div className="aspect-w-16 aspect-h-12 rounded-2xl overflow-hidden">
                    <div className="bg-gradient-to-br from-emerald-100 to-teal-200 h-full flex items-center justify-center">
                      <div className="text-center p-8">
                        ...
                        <h3 className="text-2xl font-bold text-gray-800 mb-2">Traditional Siddha Ayurveda Clinic</h3>
          ...
          <div className={`order-1 lg:order-2 ${isMounted ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'} transition-all duration-1000 delay-300`}>
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                Founded in 1998 by Dr. Ananya Sharma, Traditional Siddha Ayurveda Clinic began as a small practice with a big vision: to make authentic Ayurvedic healing accessible to everyone.
              </p>
