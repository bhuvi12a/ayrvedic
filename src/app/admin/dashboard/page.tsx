...
import { FaEnvelope, FaNewspaper, FaUsers, FaChartLine, FaCalendarCheck, FaBoxOpen, FaClipboardList, FaWarehouse } from 'react-icons/fa';
        ...
        <Card className="bg-white border-gray-200">
          ...
          <CardContent className="space-y-2 sm:space-y-3">
            <a
              ...
              className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-blue-50 hover:bg-blue-100 rounded-lg border border-blue-200 transition-colors"
            >
              <FaWarehouse className="text-blue-600 text-lg sm:text-xl shrink-0" />
              <div>
                <p className="text-gray-800 font-medium text-sm sm:text-base">View Inventory</p>
                <p className="text-gray-600 text-xs sm:text-sm">Manage products and batches</p>
              </div>
            </a>
            <a
              href="/admin/dashboard/add-inventory"
              className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-indigo-50 hover:bg-indigo-100 rounded-lg border border-indigo-200 transition-colors"
            >
              <FaBoxOpen className="text-indigo-600 text-lg sm:text-xl shrink-0" />
              <div>
                <p className="text-gray-800 font-medium text-sm sm:text-base">Add New Inventory</p>
                <p className="text-gray-600 text-xs sm:text-sm">Create new product batch</p>
              </div>
            </a>
          </CardContent>
        </Card>
