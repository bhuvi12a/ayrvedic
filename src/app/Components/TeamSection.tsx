      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-8">
          {doctors.map((doctor, index) => (
            <div
              key={index}
              className={`w-full max-w-xs bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 hover:shadow-md transition-all duration-300 ${isMounted ? 'opacity-100' : 'opacity-0'}`}
