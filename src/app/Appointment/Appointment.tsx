          ...
          {step === 2 && (
            <div className={`bg-white rounded-2xl shadow-lg p-8 ${isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-1000`}>
              ...
              <div className="space-y-8">
                ...
                {selectedDate && (
                  <div>
                    <label className="block text-gray-700 font-medium mb-4">Available Time Slots *</label>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      {availableSlots.map((slot) => (
                        <label
                          key={slot}
                          className={`block p-3 border-2 rounded-lg text-center cursor-pointer transition-all duration-300 ${
                            formData.time === slot
                              ? 'border-emerald-500 bg-emerald-50'
                              : 'border-gray-200 hover:border-emerald-300'
                          }`}
              ...
              <div className="mt-8 flex justify-between">
                ...
                <button
                  ...
                  className={`px-8 py-3 font-medium rounded-lg transition-all duration-300 shadow-md ${
                    formData.doctor && formData.service && formData.date && formData.time && !isSubmitting
